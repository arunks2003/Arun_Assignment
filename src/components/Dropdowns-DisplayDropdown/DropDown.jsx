...
import Display from '../../assests/icons/Display.svg'
import DownArror from '../../assests/icons/down.svg'
    ...
    return (
        <div className='display-dropdown' ref={componentRef}>
            <div className='dropdown-label-container' onClick={openDropdown}>
                <img src={Display} alt="No Priority" width={20} height={20} />
                <div className='dropdown-label'>Display</div>
                <img src={DownArror} alt="arrow" width={16} height={16} />
            </div>
